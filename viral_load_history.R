...
VL_data_all_HIV<-merge(x=d5, y=d6, by.x ="SID",by.y ="PID")
...
write.table(VL_data_all_HIV_suppressed, "/Users/frances/Dropbox/HIV/viral_suppression.csv", sep="\t")
